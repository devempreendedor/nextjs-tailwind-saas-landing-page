            ...
            <ol className='mt-8 space-y-6'>
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink href='https://github.com/devempreendedor/ts-nextjs-tailwind-saas-landing-page/blob/main/src/styles/colors.css'>
              ...
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnstyledLink href='https://twitter.com/lucas3couto'>
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <PrimaryLink href='https://twitter.com/lucas3couto'>
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnderlineLink href='https://twitter.com/lucas3couto'>
                    Outside Links
                  </UnderlineLink>
                </div>
              </li>
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  <ButtonLink
                    variant='primary'
                    href='https://twitter.com/lucas3couto'
                  >
                    Primary Variant
                  </ButtonLink>
                  <ButtonLink
